...
int timee[MAXLENGTH] = {0};
int expectedGravity[MAXLENGTH] ={0};
double actualGravity[MAXLENGTH] = {0};
...
//      Serial.print(inst);
//      Serial.print("|");
//      Serial.println(inst.length());
    }else{
//      Serial.print("inst is ");
//      Serial.println(inst);
...
//          Serial.println(inst.length());
      ...
      //      timee[counter/2] += parsedByte;
            if(parsedByte == 'M'){
              timee[counter/2] = atoi(s.c_str());
              Serial.println(timee[counter/2]);
              Serial.println('M');
              Serial.println();
              //Serial.println(timee[counter/2]);
...
//            
//            if (counter % 2 && 57 >= parsedByte && 48 <= parsedByte) {
//              s += inByte;
//            }
      //      timee[counter/2] += parsedByte;
            if(parsedByte == 'G'){
              expectedGravity[counter/2 + 1] = atoi(s.c_str());
              Serial.println(expectedGravity[counter/2 + 1]);
              Serial.println('G');
              //Serial.println(expectedGravity[counter/2 + 1]);
              //Serial.println(counter);
              s = "";
